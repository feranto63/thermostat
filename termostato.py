        ...
        if nome == 'Ferruccio':
            if status == 'IN':
                if Ferruccio_at_home == False:
                    ...
                    f = open("Ferruccio_at_home","a")  #apre il file dei dati in write mode, se il file non esiste lo crea
            ...
            if status == 'IN':
                if Claudia_at_home == False:
                    ...
                    bot.sendMessage(CHAT_ID, "Benvenuto a casa "+nome)
                    f = open("Claudia_at_home","a")  #apre il file dei dati in write mode, se il file non esiste lo crea
                    f.write("IN")  #scrive la info di presence sul file
                    f.close()  #chiude il file dei dati e lo salva
            ...
            if status == 'IN':
                if Lorenzo_at_home == False:
                    ...
                    bot.sendMessage(CHAT_ID, "Benvenuto a casa "+nome)
                    f = open("Lorenzo_at_home","a")  #apre il file dei dati in write mode, se il file non esiste lo crea
                    f.write("IN")  #scrive la info di presence sul file
                    f.close()  #chiude il file dei dati e lo salva
            ...
            if status == 'IN':
                if Riccardo_at_home == False:
                    ...
                    bot.sendMessage(CHAT_ID, "Benvenuto a casa "+nome)
                    f = open("Riccardo_at_home","a")  #apre il file dei dati in write mode, se il file non esiste lo crea
                    f.write("IN")  #scrive la info di presence sul file
                    f.close()  #chiude il file dei dati e lo salva
